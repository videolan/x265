...
..\vc11-x86_64\tools\dr_psnr\Release\dr_psnr.exe -r BasketballDrive_1920x1080_50.yuv -c script.yuv -w 1920 -h 1080 -e %frames% >> dr_psnr_output.txt
...
..\vc11-x86_64\tools\dr_psnr\Release\dr_psnr.exe -r FourPeople_1280x720_60.yuv -c script.yuv -w 1280 -h 720 -e %frames% >> dr_psnr_output.txt
