...
cat <<EOF
Usage: ./ConfigureBuild.bash [options]

  Help:
  -h, --help                  print this message

  ./ConfigureBuild.bash AA   -- Build the Solution for All the below Make Files
  
  Example: ./ConfigureBuild.bash AA
  
  ./ConfigureBuild.bash SS <<Make Files>> <<Build Dir Name>>  Build any Specific Make Files
  
  Example: ./ConfigureBuild.bash SS "MSYS Makefiles" "MSYS"
  ...
  NOTE : If you have MSYS, MinGW and Unix Compilers Installed then Select Option 'ALL' else BUILD with Option 'SS'
