...
{
    {
        ...
        pixel *srcPtr = (pixel*)m_reconPic->getLumaAddr() - s_tmpMarginY * 2 * m_lumaStride - s_tmpMarginX * 2;
        ...
        primitives.filterHmulti(g_bitDepthY, srcPtr, m_lumaStride,                                     // source buffer
                                ...
                                m_lumaPlane[1][0], m_lumaPlane[2][0], m_lumaPlane[3][0], m_lumaStride, // 3 (x=n, y=0) output buffers (no V interp)
                                m_filterWidth + 8, m_filterHeight + 8);
    }
