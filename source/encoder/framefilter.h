...
public:
    ...
    void init(Encoder *top, FrameEncoder *frame, int numRows, Entropy* rdGoOnSbacCoder);
...
public:
    ...
    Entropy*                    m_rdGoOnSbacCoderRow0;  // for bitstream exact only, depends on HM's bug
