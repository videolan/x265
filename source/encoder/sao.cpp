...
#if _MSC_VER // TODO: fix all these warnings
...
const int SAO::m_numCulPartsLevel[5] =
{
    1,   // level 0
    5,   // level 1
    21,  // level 2
...
const uint32_t SAO::m_eoTable[9] =
{
    1, // 0
    2, // 1
    0, // 2
...
const int SAO::m_numClass[MAX_NUM_SAO_TYPE] =
{
    SAO_EO_LEN,
    SAO_EO_LEN,
    SAO_EO_LEN,
...
const uint32_t SAO::m_maxDepth = SAO_MAX_DEPTH;
...
void SAO::processSaoUnitRow(SaoLcuParam* saoLcuParam, int idxY, int plane)
{
    ...
    uint32_t maxCUHeight = sChroma ? (m_maxCUHeight >> m_vChromaShift) : m_maxCUHeight;
...
void SAO::calcSaoStatsCu(int addr, int partIdx, int plane)
{
    ...
    int endX;
    int endY;
    pixel* pTableBo = (plane == 0) ? m_lumaTableBo : m_chromaTableBo;
