...
OPT("cpuid",           cpuid,                     required_argument, 0, "Limit SIMD arch 1:None 2:SSE2 .. 8:AVX2 (default:0 auto)")
...
OPT("me",              param->searchMethod,           required_argument, 0, "Motion search method 0:dia 1:hex 2:umh 3:star(default) 4:full")
